...
+ #[Реализовать получение детальной информации о заказе.]
...
#stp2024.listing[Пример миграции заказов][
  ...
  db.orders.insertMany([
    { _id: 1, userId: 1, createdAt: "2024-03-15", status: "completed" },
    { _id: 2, userId: 1, createdAt: "2024-03-20", status: "shipped" },
    { _id: 3, userId: 3, createdAt: "2024-04-01", status: "processing" }
  ])
  ```
]
