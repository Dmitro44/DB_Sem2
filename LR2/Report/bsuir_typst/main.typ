...
Были созданы таблицы #emph("STUDENTS") и #emph("GROUPS"). Для каждой таблицы реализованы триггеры для проверки уникальности #emph("ID") (поскольку требования задания могут выходить за рамки стандартных ограничений #emph("PRIMARY KEY")) и автоматической генерации значений через последовательности.
